...
const AddInfosCIC3Card3rdApi = () => {
    ...
    useEffect(()=>{
        fetch(`https://magical-programmer-server-from-git.onrender.com/AddInfosCIC3Card3rdApi/${id}`)
        .then(res => res.json())
    ...
    const submit = e => {
        fetch(`https://magical-programmer-server-from-git.onrender.com/AddInfosCIC3Card3rdApi`, {
            method:"POST",
            headers: {
