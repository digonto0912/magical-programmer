...
const AddInfosCourseInfoCard1 = () => {
    ...
    useEffect(()=>{
        fetch(`https://magical-programmer-server-from-git.onrender.com/AddInfosCourseInfoCard1/${id}`)
        .then(res => res.json())
    ...
    const submit = e => {
        fetch(`https://magical-programmer-server-from-git.onrender.com/AddInfosCourseInfoCard1`, {
            method:"POST",
            headers: {
