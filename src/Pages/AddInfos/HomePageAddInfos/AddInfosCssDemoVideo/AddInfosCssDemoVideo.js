...
const AddInfosCssDemoVideo = () => {
    ...
    useEffect(()=>{
        fetch(`https://magical-programmer-server-from-git.onrender.com/AddInfosCssDemoVideo/${id}`)
        .then(res => res.json())
    ...
    const submit = e => {
        fetch(`https://magical-programmer-server-from-git.onrender.com/AddInfosCssDemoVideo`, {
            method:"POST",
            headers: {
