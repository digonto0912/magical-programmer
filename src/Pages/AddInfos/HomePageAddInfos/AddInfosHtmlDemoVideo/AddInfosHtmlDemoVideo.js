...
const AddInfosHtmlDemoVideo = () => {
    ...
    useEffect(()=>{
        fetch(`https://magical-programmer-server-from-git.onrender.com/AddInfosHtmlDemoVideo/${id}`)
        .then(res => res.json())
    ...
    const submit = e => {
        fetch(`https://magical-programmer-server-from-git.onrender.com/AddInfosHtmlDemoVideo`, {
            method:"POST",
            headers: {
